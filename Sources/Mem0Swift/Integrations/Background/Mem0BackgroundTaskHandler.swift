...
public actor Mem0BackgroundTaskHandler {
    public static let shared = Mem0BackgroundTaskHandler()
    public static let taskIdentifier = "com.mem0.swift.consolidation"
    
    private let logger = Logger(subsystem: "com.mem0.swift", category: "Mem0BackgroundTaskHandler")
    ...
    private func handleBackgroundConsolidation(task: BGProcessingTask) async {
        ...
        do {
            if let client = Mem0Client.shared {
