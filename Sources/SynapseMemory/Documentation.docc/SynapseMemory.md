...
SynapseMemory provides persistent long-term memory for Apple Intelligence agentic systems, virtual assistants, and conversational native applications running on modern Apple platforms (**iOS 27.0+**, **macOS 27.0+**, **visionOS 27.0+**, **watchOS 20.0+**).
