...
Extend SynapseMemory with custom local or remote inference engines (e.g. Ollama, CoreML, Cohere).

## Overview

SynapseMemory relies on clean protocols to inject embedding models and structured extraction LLMs.
